...
class RJSMachine:
    ...
    def __init__(self, deck):
        ...
        self.mellado_orifice_radius = float(deck.doc['Machines']['Values used by Mellado to compare with experiment']['Orifice Radius'])
        self.mellado_collector_radius = float(deck.doc['Machines']['Values used by Mellado to compare with experiment']['Collector Radius'])
        self.mellado_angular_velocity = float(deck.doc['Machines']['Values used by Mellado to compare with experiment']['Angular Velocity'])
        self.mellado_initial_velocity = float(deck.doc['Machines']['Values used by Mellado to compare with experiment']['Initial Axial Velocity'])
