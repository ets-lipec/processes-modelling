...
class RJSMachine:
    ...
    def __init__(self, deck):
        ...
        self.minimum_omega = float(deck.doc['Range Machine Parameters']['Minimum Angular Velocity']) 
        self.maximum_omega = float(deck.doc['Range Machine Parameters']['Maximum Angular Velocity'])      
