...
for l in range(discretisation):
    Sigma.append(sigma(surface_tension, x_position[l], orifice_radius, initial_velocity))
...
for k in range(1,discretisation):
    radius.append(Radius(orifice_radius, rho, initial_velocity, x_position[k], mu, Sigma[k], omega))
